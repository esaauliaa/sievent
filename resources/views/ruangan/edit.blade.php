...
@section('title', 'Edit Ruangan - SiEvent UNEJ')
        ...
        <div class="mb-8">
            <div class="bg-gradient-to-r from-[#0056B3] to-[#131D4F] rounded-3xl p-8 text-white shadow-lg">
                ...
                <p class="text-white/85 leading-relaxed">
                    Perbarui data ruangan sesuai informasi terbaru.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-blue-100 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-blue-100">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Ubah data ruangan yang diperlukan.
                </p>
            </div>

            <form method="POST" action="{{ route('ruangan.update', $ruangan->id_ruangan) }}" class="p-6 space-y-6">
                @csrf
                @method('PUT')
